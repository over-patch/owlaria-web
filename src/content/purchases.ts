...
export const purchaseSupportCopy: Record<Locale, PurchaseSupportCopy> = {
  en: {
    ...
    faq: [
      ...
      },
      {
        ...
        paragraphs: [
          [
            text(
              'First, confirm that you are using the same operating system and the same Apple Account used for the purchase, then try “Restore Purchases.” If the problem continues, contact us using the in-app Owlaria support form.',
            ),
          ],
          [
            text(
              'The support form automatically includes diagnostic information needed to investigate the purchase state, including a Support ID, and lets you review it before sending. You do not need to enter the Support ID manually. The Support ID is an anonymous identifier generated by RevenueCat; it is not your Apple Account or an Owlaria user account.',
            ),
          ],
        ],
      },
    ...
    responsibility: {
      title: 'Who can help with refunds and purchase issues?',
      paragraphs: [
        'For refund decisions, billing questions, or the status of an Apple refund, contact Apple.',
        'Owlaria support can investigate app-side problems, such as a purchase, restore, or completed refund not being reflected in Owlaria.',
      ],
    },
  ...
  ja: {
    ...
    faq: [
      ...
      {
        id: 'support',
        question: '購入や復元が反映されない場合はどうすればよいですか？',
        paragraphs: [
          [
            text(
              'まず、購入したときと同じOS、同じApple Accountを使用していることを確認し、「購入を復元（Restore Purchases）」をお試しください。解決しない場合は、Owlariaのアプリ内問い合わせフォームからご連絡ください。',
            ),
          ],
          [
            text(
              '問い合わせフォームでは、購入状態の調査に必要なSupport IDなどの診断情報が自動的に添付され、送信前に内容を確認できます。Support IDを手入力する必要はありません。Support IDはRevenueCatが生成する匿名の識別子であり、Apple AccountやOwlariaのユーザーアカウントではありません。',
            ),
          ],
        ],
      },
    ...
    responsibility: {
      title: '返金・購入の問題はどこへ問い合わせればよいですか？',
      paragraphs: [
        '返金そのもの、請求内容、Appleでの返金状況については、Appleへお問い合わせください。',
        'Owlariaへお問い合わせいただけるのは、購入・復元・返金後の状態がアプリへ反映されない場合など、Owlaria側で調査できる問題です。',
      ],
    },
